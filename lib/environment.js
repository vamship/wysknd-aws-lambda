...
class Environment {
    ...
    /**
     * Gets the separator value used when generating token strings.
     *
    ...
    /**
     * Returns the token value for the current environment.
     *
     * @return {String} The token value for the current environment
     */
    get token() {
        return this._envToken;
    }
